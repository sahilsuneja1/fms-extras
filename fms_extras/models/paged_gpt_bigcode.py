...
from fms_extras.models.paged_llama import PagedMultiHeadAttention
from fms.modules.feedforward import FeedForwardBlock
from fms.utils.activation import str_to_activation
from fms_extras.utils.cache import CacheData, CacheDataLayer
...
class PagedGPTBigCode(nn.Module):
    ...
    @classmethod
    def from_config(cls, config: PagedGPTBigCodeConfig) -> "GPTBigCode":
        return cls(config)
