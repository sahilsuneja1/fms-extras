...
_20b_cobol_config = PagedGPTBigCodeConfig(
    src_vocab_size=49152,
    emb_dim=6144,
    nheads=48,
    nlayers=52,
...
_20b_cobol_ptv18_config = PagedGPTBigCodeConfig(
    src_vocab_size=49153,
    emb_dim=6144,
    nheads=48,
    nlayers=52,
    pad_id=0,
...
_20b_cobol_ptv19_config = PagedGPTBigCodeConfig(
    src_vocab_size=49152,
    emb_dim=6144,
    nheads=48,
    nlayers=52,
...
models.register_model(
    _architecture_name, "ibm.20b.cobol", _gpt_bigcode_factory_factory(_20b_cobol_config)
)
models.register_model(
    _architecture_name, "ibm.20b.cobol.ptv18", _gpt_bigcode_factory_factory(_20b_cobol_ptv18_config)
)
models.register_model(
    _architecture_name, "ibm.20b.cobol.ptv19", _gpt_bigcode_factory_factory(_20b_cobol_ptv19_config)
)
